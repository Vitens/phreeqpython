...
```pyodide session="carbonic" height="8-14" install="matplotlib,numpy,../../wheels/phreeqpython-1.6.2-py3-none-any.whl"
...
```pyodide session="carbonic" height="14-22" install="matplotlib,numpy,../../wheels/phreeqpython-1.6.2-py3-none-any.whl"
phs, co2, hco3, co3 = [], [], [], []
